...
/*Funcion que presenta datos de Senate Engagged*/
...
/*Funcion que presenta datos de Senate Loyalty*/
...
{   array.forEach(member=>{
 ...
 function documentSelection () {
   if(document.getElementById("senateAttendance")){//senateAttendance
   ...
   } else if (document.getElementById("senateLoyalty")){//senateLoyalty
      createListLoyalty(senate_statics.least_loyalty,list_leastLoyalty,'total_votes','votes_with_party_pct')
      createListLoyalty(senate_statics.most_loyalty,list_mostLoyalty,'total_votes','votes_with_party_pct')
   }
 }
 documentSelection()
